...
public class PublishFeaturesAndBundlesMojoTest
    extends AbstractTychoMojoTestCase
{
    ...
    public void testPublisher()
        throws Exception
    {
        File basedir = getBasedir( "testProject" );
        ...
        File sourceRepositoryDir =
            new File( project.getFile().getParent(), "target/sourceRepository" ).getAbsoluteFile();
    ...
    private void initLegacySupport( List<MavenProject> projects, MavenProject currentProject )
        throws Exception
    {
    ...
    private void generateContentToBePublished( File repositoryFolder )
        throws IOException
    {
