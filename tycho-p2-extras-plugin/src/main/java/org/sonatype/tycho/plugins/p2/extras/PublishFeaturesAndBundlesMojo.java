    ...
    extends AbstractMojo
{
    ...
    /**
     * Location of the metadata repository to write. The AssembleRepositoryMojo of tycho-p2-repository-plugin will only
     * work with the predefined default ${project.build.directory}/repository.
     * 
    ...
    /**
     * Location of the artifact repository to write. The AssembleRepositoryMojo of tycho-p2-repository-plugin will only
     * work with the predefined default ${project.build.directory}/repository.
     * 
     * @parameter default-value="${project.build.directory}/repository"
     */
    ...
    /**
     * Optional comma separated list of additional arguments is passed to the p2 application launcher.
     * 
    ...
    /**
     * @return array of parsed space separated list of additional arguments. Empty array if not defined.
     * @throws MojoExecutionException is thrown if parsing of additional arguments fails
     */
